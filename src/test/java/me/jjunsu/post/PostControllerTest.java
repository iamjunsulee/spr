...
public class PostControllerTest {
	...
	public void findByPost() throws Exception {
		given(this.postService.findByIdAndStatus(anyLong(), anyObject())).willReturn(new Post("力格", "牧刨明","付农促款", PostStatus.Y));
	...
	@Test
	  ...
	  public void editPostNotFoundException() throws Exception {
	    given(this.postService.findByIdAndStatus(1L, PostStatus.Y)).willReturn(new Post("力格", "牧刨明","付农促款", PostStatus.Y));
