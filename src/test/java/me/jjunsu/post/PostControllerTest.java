...
public class PostControllerTest {
	...
	public void findByPost() throws Exception {
		given(this.postService.findByIdAndStatus(anyLong(), anyObject())).willReturn(new Post("力格","何力格","牧刨明","付农促款", PostStatus.Y));
		...
		assertThat(post.getSubtitle()).isEqualTo("何力格");
	...
	@Test
	  ...
	  public void editPost() throws Exception {
	    ...
	    assertThat(postDto.getSubTitle()).isEqualTo("何力格");
	  ...
	  public void editPostNotFoundException() throws Exception {
	    given(this.postService.findByIdAndStatus(1L, PostStatus.Y)).willReturn(new Post("力格", "何力格", "牧刨明","付农促款", PostStatus.Y));
	  ...
	  public void createPost() throws Exception {
		  Post post = new Post(1L, "力格1", "何力格1", "牧刨明1","付农促款1", PostStatus.Y);
	  ...
	  public void modifyPost() throws Exception {
		  Post post = new Post(1L, "力格2","何力格2", "牧刨明2","付农促款2", PostStatus.Y);
